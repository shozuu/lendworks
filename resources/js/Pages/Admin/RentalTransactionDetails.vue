...
import { CircleDollarSign, Calendar, User, MapPin, Package, Clock, AlertCircle } from "lucide-vue-next";
...
<template>
    ...
    <div class="space-y-8">
        <!-- header -->
        <div class="sm:flex-row sm:items-center sm:justify-between bg-card flex flex-col gap-4 p-6 border rounded-lg shadow-sm">
            <div class="space-y-2">
                <div class="flex items-center gap-2">
                    <Package class="text-muted-foreground w-5 h-5" />
                    <h2 class="text-2xl font-semibold tracking-tight">Transaction #{{ rental.id }}</h2>
                </div>
                <p class="text-muted-foreground text-sm">
                    Created {{ timeAgo(rental.created_at) }}
                </p>
            </div>
            <RentalStatusBadge :status="rental.status" class="sm:text-base self-start text-sm" />
        </div>
        ...
        <div class="md:grid-cols-[2fr_1fr] grid gap-8">
                ...
                <Card class="shadow-sm">
                    ...
                    <CardContent class="p-6 space-y-6">
                        ...
                        <div class="sm:flex-row flex flex-col gap-6">
                            <img 
                                :src="rental.listing.images?.length 
                            ...
                            <div class="flex-1 space-y-4">
                                <div>
                                    ...
                                    <p class="text-muted-foreground mt-2 text-sm">{{ rental.listing.desc }}</p>
                                </div>
                                    ...
                                    <div class="flex items-start gap-2 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted-foreground">
                                                ...
                                                {{ rental.listing.location?.city }}, {{ rental.listing.location?.province }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="space-y-8">
                ...
                <Card v-if="rental.latest_rejection || rental.latest_cancellation" 
                ...
                >
                    ...
                    <CardContent class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <div v-if="rental.latest_rejection?.custom_feedback || rental.latest_cancellation?.custom_feedback" 
