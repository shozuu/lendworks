...
const isFormValid = computed(() => {
    return updateForm.resolution_type && 
...
<template>
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <h2 class="text-2xl font-semibold tracking-tight">Dispute Details #{{ dispute.id }}</h2>
            <Link 
            ...
            <Card>
                ...
                <CardContent class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div v-for="proof in dispute.rental.handover_proofs" :key="proof.id" class="space-y-2">
                            <p class="text-sm text-muted-foreground">
                    ...
                    <div class="space-y-4">
                        ...
                        <div v-for="proof in dispute.rental.return_proofs" :key="proof.id" class="space-y-2">
                            <p class="text-sm text-muted-foreground">
